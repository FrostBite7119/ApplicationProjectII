                                        ...
                                        <div id="info-awal" class="content" role="tabpanel" aria-labelledby="part-info-awal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" style="width: 100%;" name="level">
                                                    <option value="mudah" <?php if(old('level')){if(old('level') == "mudah"){ echo "selected"; }} ?>>Mudah</option>
                                                    <option value="menengah" <?php if(old('level')){if(old('level') == "menengah"){ echo "selected"; }} ?>>Menengah</option>
                                                    <option value="sulit" <?php if(old('level')){if(old('level') == "sulit"){ echo "selected"; }} ?>>Sulit</option>
                                                </select>
                                            </div>
